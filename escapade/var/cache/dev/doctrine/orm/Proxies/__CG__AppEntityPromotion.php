...
class Promotion extends \App\Entity\Promotion implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Promotion' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Promotion' . "\0" . 'taux', '' . "\0" . 'App\\Entity\\Promotion' . "\0" . 'datedebut', '' . "\0" . 'App\\Entity\\Promotion' . "\0" . 'datefin'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTaux(float $taux): \App\Entity\Promotion
    {
